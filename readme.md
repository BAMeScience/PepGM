...
<div align="center">
  <a href=https://git.bam.de/tholstei/pepgm/>
    <img src="images/peptonizer.jpg" alt="Logo"  height="90">
  </a>
...
2. All peptides found are queried in the Unipept API. Based on previous knowledge about the sample, the user is able to restrict the taxonomic range queried<br>
