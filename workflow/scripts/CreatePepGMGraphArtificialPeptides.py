...
peptides = [tuple(('ArtificialPep',{'InitialBelief_0': 0.2, 'InitialBelief_1': 0.8, 'category': 'peptide'}))]*int(args.artificial_pep_number)
print('peptides added '+str(len(peptides)))

Taxongraph.AddArtificialPeptides(peptides,'10304')
